...
#' @param model A character string or vector specifying the model types to fit (e.g., "coxph", "exp", "lognormal", "weibull"). Default is "all" to fit all models.
...
pam.metrics_summary <- function(data, time_var, status_var, covariates, model = "all", metrics = "all") {
